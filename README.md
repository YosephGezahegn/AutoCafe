	...
	<tr>
		<td>
			<ul>
				...
				<li>Login complete, Now visit <a href="https://orderworder.ritik.me/dashboard">Admin Dashboard</a></li>
...
Email: 
superadmin@orderworder.com
Password: password123 (I already ran this refresh via curl to seed your database, so it is fully ready to log into right now).# AutoCafe
# AutoCafe
